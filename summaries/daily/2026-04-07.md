...
### 2. Copilot CLI で BYOK とローカルモデルが利用可能になった
...
### 3. Dependabot アラートを AI エージェントに割り当てて修正できるようになった
...
### 4. GitHub Copilot CLI「Rubber Duck」モード（Publickey）
...
- GitHub Copilot CLI「Rubber Duck」モード（Publickey）
  - ラベル: 更新
  - URL: https://www.publickey1.jp/blog/26/github_copilot_cliaiairubber_duck.html
